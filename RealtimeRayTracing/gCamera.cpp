...
/// </summary>
gCamera::gCamera(void) : m_eye(0.0f, 0.0f, 20.0f), m_at(0.0f), m_up(0.0f, 1.0f, 0.0f), m_speed(16.0f), m_goFw(0), m_goRight(0), m_ratio(1.333f), m_slow(false)
{
	SetView( glm::vec3(0,10,20), glm::vec3(0,0,0), glm::vec3(0,1,0));

	m_dist = glm::length( m_at - m_eye );	
}

gCamera::gCamera(glm::vec3 _eye, glm::vec3 _at, glm::vec3 _up) : m_speed(16.0f), m_goFw(0), m_goRight(0), m_ratio(1.333f), m_dist(10), m_slow(false)
{
...
{
	m_ratio = _w / (float)_h;
	m_matProj = glm::perspective(	45.0f, m_ratio, 0.01f, 1000.0f);
