...
5. You can move with "WASD" and look around with your mouse, but you have to hold the left mousebutton on the window to do so. Press "p" to pause moving objects, "n" to toggle normalmaps, and "1" to toggle shadows.